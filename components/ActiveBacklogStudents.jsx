        ...
        {students.map((s) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 flex-none rounded-full bg-red-100 flex items-center justify-center text-sm font-semibold text-red-700">
            ...
            <div className="text-right">
              <div className="text-sm font-semibold text-red-600">{s.statusLabel}</div>
            </div>
          </div>
        ))}
      </div>
